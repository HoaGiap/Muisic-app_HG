...
/* ---------------- Search list ---------------- */
function SongSearch({ onPick, onDelete, refreshKey = 0 }) {
  ...
  return (
    <div style={{ ...panelStyle, display: "grid", gap: 12 }}>
      ...
      >
        ...
        />
        <Link to="/upload" style={accentButtonStyle}>
          + Thêm bài hát
        </Link>
      </div>
            ...
            >
              ...
              <button
                ...
                onClick={(e) => {
                  ...
                  const top =
                    topCandidate + menuHeight > viewportHeight
  ...
  return (
    <div style={{ ...panelStyle }}>
      ...
      <div style={{ display: "flex", gap: 16 }}>
        ...
        />
        <div style={{ display: "grid", gap: 8, flex: 0.98 }}>
          <label>
            Tiêu đề
            <br />
            <input
          ...
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "200px 180px 120px",
              columnGap: 74,
              rowGap: 16,
              alignItems: "end",
            }}
...
export default function AdminSong() {
  ...
  const deleteSong = async (song) => {
    ...
    if (!songId) return;
    const ok = confirm(
      `Xóa bài: "${song.title || "Không tên"}"? Hành động không thể hoàn tác.`
    );
    if (!ok) return;
    try {
    ...
    <div style={{ display: "grid", gap: 16, padding: 16 }}>
      ...
      {!detail ? (
        <div style={{ opacity: 0.7 }}>
          (Chọn bài hát để xem chi tiết và chỉnh sửa)
        </div>
      ) : (
        <>
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border: "1px solid var(--border)",
                background: tab === "info" ? "rgba(0,0,0,.06)" : "var(--card)",
              }}
            >
              Thông tin
            </button>
